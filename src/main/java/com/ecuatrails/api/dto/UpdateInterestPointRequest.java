...
@Schema(name = "UpdateInterestPointRequest", description = "Request para actualizar POI (parcial)")
public record UpdateInterestPointRequest(@Schema(example = "Mirador del Cóndor") String name,
