...
public record CreateInterestPointRequest(
    @Schema(example = "Mirador del Cóndor") String name,
    @Schema(example = "Vista panorámica del valle") String description,
    @Schema(example = "Km 5 vía al mirador") String address,
    @Schema(example = "Cuenca") String city,
    @Schema(example = "Lun-Dom 08:00-18:00") String openingHours,
    @Schema(example = "4.6") java.math.BigDecimal rating,
    @Schema(example = "128") Integer reviewCount,
